...
set :wp_user, "cesar" # The admin username
set :wp_email, "cesarortega@controlmas.mx" # The admin email address
set :wp_sitename, "prueba" # The site title
set :wp_localurl, "http://localhost/prueba" # Your local environment URL
...
set :repo_url, "git@github.com:CesarOrtega/prueba.git"
set :scm, :git
